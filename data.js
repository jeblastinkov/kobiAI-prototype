...
const i18n = {
  en: {
    ...
    navDocsDrop: 'Docs Drop',
    aiAssistant: 'AI Assistant',
    purposeGeneral: 'General announcements and team updates',
    purposeIncidents: 'Incident tracking and maintenance log',
    purposeDocsDrop: 'Drop documents to feed the AI knowledge base',
    purposeMachine: 'Machine channel · context-aware help',
    dashSubtitle: 'Bratislava Plant · rolling 30 days',
    factoryLabel: 'Factory: Bratislava Plant ▾',
    ...
    status_open: 'Open',
    status_awaiting_approval: 'Awaiting',
    predictiveAlertsTitle: 'Predictive Alerts',
    allClearAlerts: 'All clear — no active alerts',
    dismiss: 'Dismiss',
    createIncident: 'Create incident',
    incidentsByMachine: 'Incidents by Machine',
    aiQueryVolume: 'AI Query Volume — last 30 days',
    aiQueryHint: 'Zünd docs ingested on day 20 caused jump',
    mttrTrend: 'MTTR Trend — 12 weeks',
    mttrHint: '▼ 12% since KobiKan deployment (W7)',
    knowledgeGrowth: 'Knowledge Base Growth',
    knowledgeHint: '12,340 chunks across all machines',
    statusOnline: 'Online',
    statusMaintenance: 'Maintenance',
    mhReportIncident: 'Report Incident',
    mhGetHelp: 'Get Help',
    mhMachineStatus: 'Machine Status',
    mhReportDesc: 'Log a fault, repair or maintenance event',
    mhGetDesc: 'Ask KobiKan — get answers from the manual',
    mhStatusDesc: 'OEE, utilization trend, live signals and recent incidents',
    mhWhatWouldYouLike: 'What would you like to do?',
    mhDocsIndexed: 'Docs indexed',
    mhKnowledgeChunks: 'Knowledge chunks',
    mhDiagrams: 'Diagrams',
    mhLastIncident: 'Last incident',
    viewChannelMessages: 'View channel messages',
    oem: 'OEM',
    location: 'Location',
    ...
    showingIncidentsFor: 'Showing incidents for:',
    manageKnowledge: 'Manage Knowledge',
    indexedDocs: 'Indexed docs',
    myNotes: 'My notes',
    gaps: 'Gaps',
    uploadToDocsDrop: 'Upload to #docs-drop',
    colTag: 'Tag',
    colValue: 'Value',
    colState: 'State',
    signalOk: 'OK',
    ...
    cmdAsk: 'Ask KobiKan a question',
    cmdAskKobi: 'Ask KobiKan (same as AI button)',
    cmdAddNote: 'Add a maintenance note',
    cmdIncident: 'Log a structured incident',
    cmdSearch: 'Search messages and docs',
    cmdAssign: 'Assign incident to technician',
    cmdPlaybook: 'Run maintenance playbook',
    cmdReport: 'Generate weekly report',
    dropFormats: 'PDFs · Schematics · Manuals · Images',
    dropOnPrem: 'Files stay on-prem. Nothing leaves this factory.',
    composerHint: 'Type / for commands · @kobi to ask AI',
    askKobiKan: 'Ask KobiKan',
    uploadingContext: 'Uploading in context of',
    uploadingContextSuffix: '— documents will be tagged for that line.',
    backToMachineChannel: 'Back to machine channel',
    botFallback: "I'm ready to help. Could you clarify your question?",
    noteAddedTitle: 'New knowledge added by',
    noteAddedJustNow: 'just now',
    noteCategory: 'Category',
    noteSeverity: 'Severity',
    noteIndexedIn: 'Indexed in 2.1s · Now searchable.',
    documentReceived: 'Document received. Indexing…',
    openingIncidentForm: 'Opening incident form…',
    comingProduction: 'Coming in production 🚀',
    addNoteTitle: 'Add Maintenance Note',
    addNoteSubtitle: 'Captured knowledge is immediately searchable by the AI',
    fieldMachine: 'Machine',
    currentMachine: 'Current Machine',
    fieldCategory: 'Category',
    fieldWhatHappened: 'What happened',
    fieldWhatHint: 'or use voice input',
    fieldSeverity: 'Severity',
    fieldPhoto: 'Photo (optional)',
    attachPhoto: 'Attach photo',
    describePlaceholder: 'Describe what you saw or what you fixed…',
    catRepair: 'Repair',
    catObservation: 'Observation',
    catTip: 'Tip',
    catIncidentNote: 'Incident note',
    sevInfo: 'Info',
    sevWarning: 'Warning',
    ...
    tabDetails: 'Incident Details',
    tabTasks: 'Resolution Tasks',
    tabParts: 'Parts & Notes',
    fieldLocation: 'Location in machine',
    fieldLocationHint: 'e.g. Motor module slot 4',
    locationPlaceholder: 'Hall A, Line 3 — axis 3',
    fieldFaultDesc: 'Fault description',
    faultPlaceholder: 'Describe the fault, symptoms, and what you observed…',
    fieldComponent: 'Component identified',
    componentPlaceholder: 'e.g., Timing belt (3M-225-6)',
    resolutionChecklist: 'Resolution Checklist',
    tasksDone: 'done',
    tasksCompliance: 'Complete all tasks before submitting for approval to ensure compliance tracking.',
    resolutionType: 'Resolution type',
    resolutionNotes: 'Resolution notes',
    resolutionNotesPlaceholder: 'What was done to resolve the issue?',
    ...
    incidentSubtitle: 'Structured maintenance record · auto-posts to #incidents',
    logIncidentTitle: 'Log Incident',
    onPremBody1: 'KobiKan runs entirely on your infrastructure. No cloud, no outbound traffic, no data shared with any third party.',
    onPremBody2: 'Every document, every question, every log stays on your server — inside your firewall, under your control.',
    badgeOnPrem: 'On-Premise',
    badgeAirGap: 'Air-Gapped Capable',
    badgeIso: 'ISO 27001 / TISAX Ready',
    onPremFooter: 'Delivered as an on-prem appliance by Touch4IT · NIST · ISO 27001 · ISO 14001',
    searchPlaceholder: 'Search messages, documents, notes…',
    searchHint: 'Type to search messages, documents, notes…',
    searchEsc: 'Esc',
    incidentOpened: 'Incident opened by',
    incidentAwaiting: 'Awaiting approval',
    viewInLogbook: 'View in Logbook →',
    resolutionPermanent: 'Permanent',
    resolutionTemporary: 'Temporary',
    openingDocument: 'Open document preview',
    viewSource: 'View',
    pagesChunksFmt: '{pages} pages · {chunks} chunks · {diagrams} diagrams',
    compressor: 'Compressor',
    conveyorL4: 'Conveyor L4',
    chartAnnotationZund: 'Zünd docs',
    chartAnnotationKobi: 'KobiKan',
  },
  sk: {
    ...
    navMachines: 'Stroje',
    navDashboard: 'Dashboard',
    navGeneral: 'Všeobecné',
    navIncidents: 'Incidenty',
    navDocsDrop: 'Dokumenty',
    aiAssistant: 'AI Asistent',
    purposeGeneral: 'Všeobecné oznámenia a aktualizácie tímu',
    purposeIncidents: 'Sledovanie incidentov a protokol údržby',
    purposeDocsDrop: 'Presuňte dokumenty pre znalostnú bázu AI',
    purposeMachine: 'Kanál stroja · kontextová pomoc',
    dashSubtitle: 'Závod Bratislava · posledných 30 dní',
    factoryLabel: 'Závod: Bratislava ▾',
    trendImprovement: 'zlepšenie',
    trendThisWeek: 'tento týždeň',
    ...
    colIssue: 'Problém',
    colStatus: 'Stav',
    colResolvedBy: 'Vyriešil',
    status_resolved: 'Vyriešené',
    status_in_progress: 'Prebieha',
    status_open: 'Otvorené',
    status_awaiting_approval: 'Čaká na schválenie',
    predictiveAlertsTitle: 'Prediktívne upozornenia',
    allClearAlerts: 'Všetko v poriadku — žiadne aktívne alarmy',
    dismiss: 'Zavrieť',
    createIncident: 'Vytvoriť incident',
    incidentsByMachine: 'Incidenty podľa stroja',
    aiQueryVolume: 'Objem AI dotazov — posledných 30 dní',
    aiQueryHint: 'Ingestia dokumentov Zünd v deň 20 spôsobila skok',
    mttrTrend: 'Trend MTTR — 12 týždňov',
    mttrHint: '▼ 12 % od nasadenia KobiKan (T7)',
    knowledgeGrowth: 'Rast znalostnej bázy',
    knowledgeHint: '12 340 chunkov naprieč všetkými strojmi',
    statusOnline: 'Online',
    statusMaintenance: 'Údržba',
    mhReportIncident: 'Nahlásiť incident',
    mhGetHelp: 'Požiadať o pomoc',
    mhMachineStatus: 'Stav stroja',
    mhReportDesc: 'Zaznamenajte poruchu, opravu alebo údržbu',
    mhGetDesc: 'Opýtajte KobiKan — odpovede z manuálu',
    mhStatusDesc: 'OEE, trend využitia, signály v reálnom čase a incidenty',
    mhWhatWouldYouLike: 'Čo chcete urobiť?',
    mhDocsIndexed: 'Indexované dokumenty',
    mhKnowledgeChunks: 'Chunky znalostí',
    mhDiagrams: 'Diagramy',
    mhLastIncident: 'Posledný incident',
    viewChannelMessages: 'Zobraziť správy kanála',
    oem: 'OEM',
    location: 'Umiestnenie',
    commissioned: 'Uvedené do prevádzky',
    lastIncident: 'Posledný incident',
    knowledgeBase: 'Znalostná báza',
    docs: 'Dokumenty',
    chunks: 'Chunky',
    diagrams: 'Diagramy',
    viewAllIncidents: 'Zobraziť všetky incidenty',
    uploadDocs: 'Nahrať dokumenty',
    maintenanceLogbook: 'Protokol údržby',
    showingIncidentsFor: 'Incidenty pre:',
    manageKnowledge: 'Spravovať znalosti',
    indexedDocs: 'Indexované dokumenty',
    myNotes: 'Moje poznámky',
    gaps: 'Medzery',
    uploadToDocsDrop: 'Nahrať do #docs-drop',
    colTag: 'Tag',
    colValue: 'Hodnota',
    colState: 'Stav',
    signalOk: 'OK',
    ...
    viewFullSize: 'Zobraziť v plnej veľkosti',
    diagram: 'Diagram',
    sourcesCount: 'Zdroje',
    pagesUnit: 'strán',
    tagged: 'Označené:',
    openedBy: 'Otvoril',
    resolvedByLabel: 'Vyriešil',
    partsLabel: 'Diely',
    reply: 'odpoveď',
    replies: 'odpovedí',
    follow: 'Sledovať',
    ...
    commands: 'Príkazy',
    comingSoon: 'čoskoro',
    cmdAsk: 'Opýtať KobiKan otázku',
    cmdAskKobi: 'Opýtať KobiKan (ako tlačidlo AI)',
    cmdAddNote: 'Pridať poznámku údržby',
    cmdIncident: 'Zaznamenať štruktúrovaný incident',
    cmdSearch: 'Hľadať správy a dokumenty',
    cmdAssign: 'Priradiť incident technikovi',
    cmdPlaybook: 'Spustiť playbook údržby',
    cmdReport: 'Generovať týždenný report',
    dropFormats: 'PDF · Schémy · Manuály · Obrázky',
    dropOnPrem: 'Súbory zostávajú on-prem. Nič neopustí závod.',
    composerHint: 'Píšte / pre príkazy · @kobi pre AI',
    askKobiKan: 'Opýtať KobiKan',
    uploadingContext: 'Nahrávanie v kontexte',
    uploadingContextSuffix: '— dokumenty budú označené pre túto linku.',
    backToMachineChannel: 'Späť na kanál stroja',
    botFallback: 'Som pripravený pomôcť. Môžete upresniť svoju otázku?',
    noteAddedTitle: 'Nová znalosť pridaná',
    noteAddedJustNow: 'práve teraz',
    noteCategory: 'Kategória',
    noteSeverity: 'Závažnosť',
    noteIndexedIn: 'Indexované za 2,1 s · Teraz vyhľadávateľné.',
    documentReceived: 'Dokument prijatý. Indexujem…',
    openingIncidentForm: 'Otváram formulár incidentu…',
    comingProduction: 'Čoskoro v produkcii 🚀',
    addNoteTitle: 'Pridať poznámku údržby',
    addNoteSubtitle: 'Zachytené znalosti sú okamžite vyhľadávateľné AI',
    fieldMachine: 'Stroj',
    currentMachine: 'Aktuálny stroj',
    fieldCategory: 'Kategória',
    fieldWhatHappened: 'Čo sa stalo',
    fieldWhatHint: 'alebo hlasový vstup',
    fieldSeverity: 'Závažnosť',
    fieldPhoto: 'Foto (voliteľné)',
    attachPhoto: 'Priložiť foto',
    describePlaceholder: 'Opíšte, čo ste videli alebo opravili…',
    catRepair: 'Oprava',
    catObservation: 'Pozorovanie',
    catTip: 'Tip',
    catIncidentNote: 'Poznámka k incidentu',
    sevInfo: 'Info',
    sevWarning: 'Varovanie',
    sevCritical: 'Kritické',
    owner: 'Vlastník',
    participants: 'Účastníci',
    machineLabel: 'Stroj',
    tabDetails: 'Detaily incidentu',
    tabTasks: 'Úlohy riešenia',
    tabParts: 'Diely a poznámky',
    fieldLocation: 'Umiestnenie v stroji',
    fieldLocationHint: 'napr. slot motorového modulu 4',
    locationPlaceholder: 'Hala A, Linka 3 — os 3',
    fieldFaultDesc: 'Popis poruchy',
    faultPlaceholder: 'Opíšte poruchu, príznaky a pozorovania…',
    fieldComponent: 'Identifikovaná súčiastka',
    componentPlaceholder: 'napr. Remeň (3M-225-6)',
    resolutionChecklist: 'Kontrolný zoznam riešenia',
    tasksDone: 'hotovo',
    tasksCompliance: 'Pred odoslaním na schválenie dokončite všetky úlohy pre compliance.',
    resolutionType: 'Typ riešenia',
    resolutionNotes: 'Poznámky k riešeniu',
    resolutionNotesPlaceholder: 'Čo bolo urobené na vyriešenie?',
    sparePartsUsed: 'Použité náhradné diely',
    partName: 'Názov dielu',
    qty: 'Množ.',
    addPart: '+ Pridať diel',
    tasksChecked: 'úloh skontrolovaných',
    saveDraft: 'Uložiť koncept',
    incidentSubtitle: 'Štruktúrovaný záznam údržby · auto-post do #incidents',
    logIncidentTitle: 'Zaznamenať incident',
    onPremBody1: 'KobiKan beží výhradne na vašej infraštruktúre. Bez cloudu, bez odchádzajúceho trafficu, bez zdieľania dát.',
    onPremBody2: 'Každý dokument, každá otázka, každý log zostáva na vašom serveri — vo vašom firewalle, pod vašou kontrolou.',
    badgeOnPrem: 'On-Premise',
    badgeAirGap: 'Air-Gap schopné',
    badgeIso: 'ISO 27001 / TISAX Ready',
    onPremFooter: 'Dodávané ako on-prem appliance od Touch4IT · NIST · ISO 27001 · ISO 14001',
    searchPlaceholder: 'Hľadať správy, dokumenty, poznámky…',
    searchHint: 'Píšte pre hľadanie správ, dokumentov, poznámok…',
    searchEsc: 'Esc',
    incidentOpened: 'Incident otvorený',
    incidentAwaiting: 'Čaká na schválenie',
    viewInLogbook: 'Zobraziť v logbooku →',
    resolutionPermanent: 'Trvalé',
    resolutionTemporary: 'Dočasné',
    openingDocument: 'Otvoriť náhľad dokumentu',
    viewSource: 'Zobraziť',
    pagesChunksFmt: '{pages} strán · {chunks} chunkov · {diagrams} diagramov',
    compressor: 'Kompresor',
    conveyorL4: 'Dopravník L4',
    chartAnnotationZund: 'Dok. Zünd',
    chartAnnotationKobi: 'KobiKan',
  },
};
